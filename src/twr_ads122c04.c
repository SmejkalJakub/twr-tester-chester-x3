...
bool twr_ads122c04_measure_x3c(twr_ads122c04_t *ctx)
{
    if (!twr_ads122c04_reset(ctx))
    {
        return false;
...
bool twr_ads122c04_read_x3c(twr_ads122c04_t *ctx, int32_t *value)
{
    uint8_t cr2;
    int32_t data;
...
bool twr_ads122c04_measure_x3a(twr_ads122c04_t *ctx)
{
    if (!twr_ads122c04_reset(ctx))
    {
        return false;
...
bool twr_ads122c04_read_x3a(twr_ads122c04_t *ctx, float *value)
{
    uint8_t cr2;
    uint32_t data;
    ...
    *value = temperature_sensor_resistance_ohm_to_temperature_celsius(r, 1000, RTD_A, RTD_B);
